...
<img src="{$base_dir|escape:'htmlall':'UTF-8'}modules/alipay/views/img/loading.gif" />
...
{ldelim}
	$.ajax({ldelim}
		type:"POST",
		async:true,
		url:'{$base_dir|escape:'htmlall':'UTF-8'}modules/alipay/check_order.php',
